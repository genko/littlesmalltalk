...
# ifndef basicAt
object basicAt(object z, register int i)
{
    if (isInteger(z))
...
void basicAtPut(object z, register int i, object v)
{
    simpleAtPut(z, i, v);
    incr(v);
}
...
# ifndef fieldAtPut
void fieldAtPut(object z, register int i, object v)
{
    decr(basicAt(z, i));
    basicAtPut(z, i, v);
}
...
# ifndef byteAt
int byteAt(object z, register int i)
{
    byte *bp;
    unsigned char t;
